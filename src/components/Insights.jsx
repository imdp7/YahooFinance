                ...
                <SpaceBetween size="s">
                  <ColumnLayout columns={4}>
                    ...
                    <Pie
                      size="medium"
                      value={
                        insights?.companySnapshot?.company?.earningsReports
                      }
                      title="Earning Reports"
                      footer={
                        insights?.companySnapshot?.sector?.earningsReports
                      }
                    />
                ...
                <Container
                  ...
                  <ColumnLayout columns={4} borders="all" variant="text-grid">
                    <FormField label="State Description">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.stateDescription
                      }
                    </FormField>
                    <FormField label="Direction">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.direction
                      }
                    </FormField>
                    <FormField label="Score">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.score
                      }
                    </FormField>
                    <FormField label="Score Description">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.scoreDescription
                      }
                    </FormField>
                    <FormField label="Sector Direction">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.sectorDirection
                      }
                    </FormField>
                    <FormField label="Sector Score">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.sectorScore
                      }
                    </FormField>
                    <FormField label="Sector Score Description">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.sectorScoreDescription
                      }
                    </FormField>
                    <FormField label="Index Direction">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.indexDirection
                      }
                    </FormField>
                    <FormField label="Index Score">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.indexScore
                      }
                    </FormField>
                    <FormField label="Index Score Description">
                      {
                        insights?.instrumentInfo?.technicalEvents
                          ?.longTermOutlook?.indexScoreDescription
                      }
                    </FormField>
                  </ColumnLayout>
                </Container>
